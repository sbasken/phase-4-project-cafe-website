...
with app.app_context():
    ...
    # order_item1 = OrderItem(quantity=2, menuitem_id=1, receipt_id=1)
    # order_item2 = OrderItem(quantity=1, menuitem_id=2, receipt_id=1)
    # order_item8 = OrderItem(quantity=3, menuitem_id=3, receipt_id=1)
    # order_item3 = OrderItem(quantity=1, menuitem_id=3, receipt_id=1)
    # order_item4 = OrderItem(quantity=3, menuitem_id=5, receipt_id=3)
    # order_item5 = OrderItem(quantity=2, menuitem_id=6, receipt_id=3)
    # order_item6 = OrderItem(quantity=1, menuitem_id=8, receipt_id=4)
    # order_item7 = OrderItem(quantity=1, menuitem_id=10, receipt_id=3)
